...
def update_mid_frame(self):
    ...
    self.OSR_label.update(self.current_clock, self.hex_check_val.get())
    self.ISR_label.update(self.current_clock, self.hex_check_val.get())
    self.X_label.update(self.current_clock, self.hex_check_val.get())
    self.Y_label.update(self.current_clock, self.hex_check_val.get())
    self.GPIO_label.update(self.current_clock, self.hex_check_val.get())
    self.GPIO_ext_label.update(self.current_clock, self.hex_check_val.get())
    self.GPIO_pindirs_label.update(self.current_clock, self.hex_check_val.get())
    self.IRQ_label.update(self.current_clock, self.hex_check_val.get())
    self.in_pins_label.update(self.current_clock, self.hex_check_val.get())
    self.out_pins_label.update(self.current_clock, self.hex_check_val.get())
    self.out_vals_label.update(self.current_clock, self.hex_check_val.get())
    self.set_vals_label.update(self.current_clock, self.hex_check_val.get())
    self.set_pins_label.update(self.current_clock, self.hex_check_val.get())
    self.sideset_pins_label.update(self.current_clock, self.hex_check_val.get())
    self.sideset_vals_label.update(self.current_clock, self.hex_check_val.get())
    self.jmp_pin_label.update(self.current_clock, self.hex_check_val.get())
